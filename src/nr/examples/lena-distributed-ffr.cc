...
int main (int argc, char *argv[])
{
  ...
  nrHelper->SetFfrAlgorithmAttribute ("CalculationInterval", TimeValue (MilliSeconds (200)));
  ...
  //ns3::NrFfrDistributedAlgorithm works with Absolute Mode Uplink Power Control
  Config::SetDefault ("ns3::NrUePowerControl::AccumulationEnabled", BooleanValue (false));
