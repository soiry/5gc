...
/*
 * Simple simulation program using the emulated NGC.
 * For the NR radio part, it simulates a simple linear topology with
 ...
 * For the NGC, it uses EmuNgcHelper to realize the N2-U connection
 * via a real link. 
 */

NS_LOG_COMPONENT_DEFINE ("NgcFirstExample");
