...
main (int argc, char *argv[])
{
  ...
  // Install NR Devices in eNB and UEs
  Config::SetDefault ("ns3::NrEnbPhy::TxPower", DoubleValue (enbTxPowerDbm));
  ...
  for (uint16_t i = 0; i < numberOfUes; i++)
    {
      nrHelper->Attach (ueNrDevs.Get (i), enbNrDevs.Get (0));
    }
  ...
  // X2-based Handover
  //nrHelper->HandoverRequest (Seconds (0.100), ueNrDevs.Get (0), enbNrDevs.Get (0), enbNrDevs.Get (1));
  ...
  Config::Connect ("/NodeList/*/DeviceList/*/NrEnbRrc/ConnectionEstablished",
