    ...
    bankSize (0)
{
  ...
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNrFfrSapUser<TdTbfqFfMacScheduler> (this);
}
...
void
TdTbfqFfMacScheduler::SetNrFfrSapProvider (NrFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NrFfrSapUser*
TdTbfqFfMacScheduler::GetNrFfrSapUser ()
{
  return m_ffrSapUser;
}
