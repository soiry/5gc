    ...
    bankSize (0)
{
  ...
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberNrFfrSapUser<FdTbfqFfMacScheduler> (this);
}
...
void
FdTbfqFfMacScheduler::SetNrFfrSapProvider (NrFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

NrFfrSapUser*
FdTbfqFfMacScheduler::GetNrFfrSapUser ()
{
  return m_ffrSapUser;
}
