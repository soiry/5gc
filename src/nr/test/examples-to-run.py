...
cpp_examples = [
    ...
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::TtaFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::TdTbfqFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::TdMtFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::TdBetFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::RrFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::PssFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::PfFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::FdTbfqFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::FdMtFfMacScheduler", "options.valgrind", "True"),
    ("lena-simple-ngc --simTime=1.1 --ns3::NrHelper::Scheduler=ns3::FdBetFfMacScheduler", "options.valgrind", "True"),
]
