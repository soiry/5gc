...
#include "nr-test-downlink-power-control.h"
#include <ns3/nr-rrc-sap.h>

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("NrDownlinkPowerControlTest");

/**
 * TestSuite
 */

NrDownlinkPowerControlTestSuite::NrDownlinkPowerControlTestSuite ()
  : TestSuite ("nr-downlink-power-control", SYSTEM)
{
//  LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_DEBUG);
//  LogComponentEnable ("NrDownlinkPowerControlTest", logLevel);
  NS_LOG_INFO ("Creating NrDownlinkPowerControlTestSuite");
  ...
  // Spectrum helper test
  {
    ...
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB_6);
    powerTxMap.insert (std::pair<int,double>(0, rbTxPower));

    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB_3);
    powerTxMap.insert (std::pair<int,double>(2, rbTxPower));

    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB0);
    powerTxMap.insert (std::pair<int,double>(3, rbTxPower));

    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB2);
    powerTxMap.insert (std::pair<int,double>(5, rbTxPower));

    SpectrumValue spectrumValue_txpowdB30nrb6run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
    ...
    AddTestCase (new NrDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb6run1earfcn500_allRbPower",
                                                                   earfcn, bw, powerTx,
  ...
  }
  {
    ...
    AddTestCase (new NrDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb6run1earfcn500",
                                                                   earfcn, bw, powerTx,
                                                                   powerTxMap, activeRbs_txpowdB30nrb6run1earfcn500,
                                                                   spectrumValue_txpowdB30nrb6run1earfcn500), TestCase::QUICK);
  }
  {
    ...
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB_3);
    powerTxMap.insert (std::pair<int,double>(0, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB_4dot77);
    powerTxMap.insert (std::pair<int,double>(1, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB_6);
    powerTxMap.insert (std::pair<int,double>(2, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB1);
    powerTxMap.insert (std::pair<int,double>(3, rbTxPower));
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB2);
    ...
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB_1dot77);
    ...
    rbTxPower = CalculateRbTxPower (powerTx, NrRrcSap::PdschConfigDedicated::dB3);
    powerTxMap.insert (std::pair<int,double>(24, rbTxPower));


    SpectrumValue spectrumValue_txpowdB30nrb25run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, bw));
    ...
    AddTestCase (new NrDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb25run1earfcn500_allRbPower",
                                                                   earfcn, bw, powerTx,
  ...
  }
  {
    ...
    AddTestCase (new NrDownlinkPowerControlSpectrumValueTestCase ("txpowdB30nrb25run1earfcn500",
                                                                   earfcn, bw, powerTx,
                                                                   powerTxMap, activeRbs_txpowdB30nrb25run1earfcn500,
                                                                   spectrumValue_txpowdB30nrb25run1earfcn500), TestCase::QUICK);
  }
  ...
  AddTestCase (new NrDownlinkPowerControlTestCase (false, NrRrcSap::PdschConfigDedicated::dB0,
                                                    "DataCtrlPowerDifference_noChange"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB_6,
                                                    "DataCtrlPowerDifference_dB_6"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB_4dot77,
                                                    "DataCtrlPowerDifference_dB_4dot77"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB_3,
                                                    "DataCtrlPowerDifference_dB_3"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB_1dot77,
                                                    "DataCtrlPowerDifference_dB_1dot77"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB0,
                                                    "DataCtrlPowerDifference_dB0"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB1,
                                                    "DataCtrlPowerDifference_dB1"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB2,
                                                    "DataCtrlPowerDifference_dB2"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlTestCase (true, NrRrcSap::PdschConfigDedicated::dB3,
                                                    "DataCtrlPowerDifference_dB3"), TestCase::QUICK);


  // RrcConnectionReconfiguration test
  AddTestCase (new NrDownlinkPowerControlRrcConnectionReconfigurationTestCase (false, "RrcConnReconf-IdealRrc"), TestCase::QUICK);
  AddTestCase (new NrDownlinkPowerControlRrcConnectionReconfigurationTestCase (true, "RrcConnReconf-RealRrc"), TestCase::QUICK);


}

double
NrDownlinkPowerControlTestSuite::CalculateRbTxPower (double txPower, uint8_t pa)
{
  NrRrcSap::PdschConfigDedicated pdschConfigDedicated;
  pdschConfigDedicated.pa = pa;
  double rbTxpower = txPower + NrRrcSap::ConvertPdschConfigDedicated2Double (pdschConfigDedicated);

  return rbTxpower;
}

static NrDownlinkPowerControlTestSuite nrDownlinkPowerControlTestSuite;
...
NrDownlinkPowerControlSpectrumValueTestCase::NrDownlinkPowerControlSpectrumValueTestCase (std::string name,
  ...
  : TestCase ("Downlink Power Control: " + name),
    m_actual (NrSpectrumValueHelper::CreateTxPowerSpectralDensity (earfcn, bw, powerTx, powerTxMap, activeRbs)),
    m_expected (Create<SpectrumValue> (expected))
{
  NS_LOG_INFO ("Creating NrDownlinkPowerControlTestCase");
}

NrDownlinkPowerControlSpectrumValueTestCase::~NrDownlinkPowerControlSpectrumValueTestCase ()
{
}

void
NrDownlinkPowerControlSpectrumValueTestCase::DoRun (void)
{
  NS_LOG_INFO ("Creating NrDownlinkPowerControlSpectrumValueTestCase");
...
NrDownlinkPowerControlTestCase::NrDownlinkPowerControlTestCase (bool changePower, uint8_t pa, std::string name)
  : TestCase ("Downlink Power Control: " + name)
{
  m_changePdschConfigDedicated = changePower;
  m_pdschConfigDedicated.pa = pa;
  m_expectedPowerDiff = NrRrcSap::ConvertPdschConfigDedicated2Double (m_pdschConfigDedicated);
  NS_LOG_INFO ("Creating NrDownlinkPowerControlTestCase");
}

NrDownlinkPowerControlTestCase::~NrDownlinkPowerControlTestCase ()
{
}

void
NrDownlinkPowerControlTestCase::DoRun (void)
{
  Config::Reset ();
  ...
  Ptr<NrFfrSimple> simpleFfrAlgorithm = DynamicCast<NrFfrSimple>(tmp.GetObject ());
  ...
  Ptr<NrPhy> ue1Phy = ueDevs.Get (0)->GetObject<NrUeNetDevice> ()->GetPhy ()->GetObject<NrPhy> ();

  Ptr<NrChunkProcessor> testDlDataPowerReceived = Create<NrChunkProcessor> ();
  NrSpectrumValueCatcher dlDataPowerReceivedCatcher;
  testDlDataPowerReceived->AddCallback (MakeCallback (&NrSpectrumValueCatcher::ReportValue, &dlDataPowerReceivedCatcher));
  ue1Phy->GetDownlinkSpectrumPhy ()->AddDataPowerChunkProcessor (testDlDataPowerReceived);

  Ptr<NrChunkProcessor> testDlCtrlPowerReceived = Create<NrChunkProcessor> ();
  NrSpectrumValueCatcher dlCtrlPowerReceivedCatcher;
  testDlCtrlPowerReceived->AddCallback (MakeCallback (&NrSpectrumValueCatcher::ReportValue, &dlCtrlPowerReceivedCatcher));
...
void
NotifyConnectionReconfigurationUe (NrDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
...
void
NotifyConnectionReconfigurationEnb (NrDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
                                    std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti)
{
...
void
ChangePdschConfigDedicatedCallback (NrDownlinkPowerControlRrcConnectionReconfigurationTestCase *testcase,
...
NrDownlinkPowerControlRrcConnectionReconfigurationTestCase::NrDownlinkPowerControlRrcConnectionReconfigurationTestCase (bool useIdealRrc, std::string name)
  : TestCase ("Downlink Power Control: " + name),
...
NrDownlinkPowerControlRrcConnectionReconfigurationTestCase::~NrDownlinkPowerControlRrcConnectionReconfigurationTestCase ()
{
}

void
NrDownlinkPowerControlRrcConnectionReconfigurationTestCase::ConnectionReconfigurationEnb (std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti)
{
...
void
NrDownlinkPowerControlRrcConnectionReconfigurationTestCase::ConnectionReconfigurationUe (std::string context, uint64_t imsi, uint16_t cellid, uint16_t rnti)
{
  if (Simulator::Now () > MilliSeconds (100))
    {
...
void
NrDownlinkPowerControlRrcConnectionReconfigurationTestCase::ChangePdschConfigDedicated (uint16_t rnti, uint8_t pa)
{
...
void
NrDownlinkPowerControlRrcConnectionReconfigurationTestCase::DoRun (void)
{
  Config::Reset ();
  ...
  */
  ...
  Ptr<NrFfrSimple> simpleFfrAlgorithm = DynamicCast<NrFfrSimple>(tmp.GetObject ());
  NrRrcSap::PdschConfigDedicated pdschConfigDedicated;
  pdschConfigDedicated.pa = NrRrcSap::PdschConfigDedicated::dB_6;
  ...
  Config::Connect ("/NodeList/0/DeviceList/0/NrFfrAlgorithm/ChangePdschConfigDedicated",
                   MakeBoundCallback (&ChangePdschConfigDedicatedCallback, this));
  Config::Connect ("/NodeList/1/DeviceList/0/NrUeRrc/ConnectionReconfiguration",
                   MakeBoundCallback (&NotifyConnectionReconfigurationUe, this));
  Config::Connect ("/NodeList/0/DeviceList/0/NrEnbRrc/ConnectionReconfiguration",
