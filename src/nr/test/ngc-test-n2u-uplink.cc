...
NS_LOG_COMPONENT_DEFINE ("NgcTestN2uUplink");
 ...
 * generated by the NrEnbNetDevice when forwarding packet in the
 * uplink. But in this test we don't have the NrEnbNetDevice, because
 * we test the N2-U interface with simpler devices to make sure it
 * just works.
 * 
 */
...
class NgcN2uUlTestCase : public TestCase
{
public:
  NgcN2uUlTestCase (std::string name, std::vector<EnbUlTestData> v);
  virtual ~NgcN2uUlTestCase ();
...
NgcN2uUlTestCase::NgcN2uUlTestCase (std::string name, std::vector<EnbUlTestData> v)
  : TestCase (name),
    m_enbUlTestData (v)
{
}

NgcN2uUlTestCase::~NgcN2uUlTestCase ()
{
}

void 
NgcN2uUlTestCase::DoRun ()
{
      ...
      for (uint32_t u = 0; u < ues.GetN (); ++u)
        {
          ...
          Ipv4Address gwAddr = ngcHelper->GetUeDefaultGatewayAddress ();
 ...
 */
class NgcN2uUlTestSuite : public TestSuite
{
public:
  NgcN2uUlTestSuite ();
  
} g_ngcN2uUlTestSuiteInstance;

NgcN2uUlTestSuite::NgcN2uUlTestSuite ()
  : TestSuite ("ngc-n2u-uplink", SYSTEM)
{  
  ...
  e1.ues.push_back (f1);
  v1.push_back (e1);
  AddTestCase (new NgcN2uUlTestCase ("1 eNB, 1UE", v1), TestCase::QUICK);
  ...
  v2.push_back (e2);
  AddTestCase (new NgcN2uUlTestCase ("1 eNB, 2UEs", v2), TestCase::QUICK);


  std::vector<EnbUlTestData> v3;  
  v3.push_back (e1);
  v3.push_back (e2);
  AddTestCase (new NgcN2uUlTestCase ("2 eNBs", v3), TestCase::QUICK);
  ...
  v4.push_back (e1);
  v4.push_back (e2);
  AddTestCase (new NgcN2uUlTestCase ("3 eNBs", v4), TestCase::QUICK);
  ...
  e5.ues.push_back (f5);
  v5.push_back (e5);
  AddTestCase (new NgcN2uUlTestCase ("1 eNB, 10 pkts 3000 bytes each", v5), TestCase::QUICK);
  ...
  e6.ues.push_back (f6);
  v6.push_back (e6);
  AddTestCase (new NgcN2uUlTestCase ("1 eNB, 50 pkts 3000 bytes each", v6), TestCase::QUICK);
  ...
  e7.ues.push_back (f7);
  v7.push_back (e7);
  AddTestCase (new NgcN2uUlTestCase ("1 eNB, 10 pkts 15000 bytes each", v7), TestCase::QUICK);
  ...
  e8.ues.push_back (f8);
  v8.push_back (e8);
  AddTestCase (new NgcN2uUlTestCase ("1 eNB, 100 pkts 15000 bytes each", v8), TestCase::QUICK);
