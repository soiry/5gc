...
NrRrcHeaderTestCase::AssertEqualRadioResourceConfigDedicated (NrRrcSap::RadioResourceConfigDedicated rrcd1, NrRrcSap::RadioResourceConfigDedicated rrcd2)
{
  ...
  std::list<NrRrcSap::SrbToAddMod>::iterator it1 = srcSrbToAddModList.begin ();
  std::list<NrRrcSap::SrbToAddMod> dstSrbToAddModList = rrcd2.srbToAddModList;
  std::list<NrRrcSap::SrbToAddMod>::iterator it2 = dstSrbToAddModList.begin ();
  ...
  std::list<NrRrcSap::DrbToAddMod>::iterator it3 = srcDrbToAddModList.begin ();
  std::list<NrRrcSap::DrbToAddMod> dstDrbToAddModList = rrcd2.drbToAddModList;
  std::list<NrRrcSap::DrbToAddMod>::iterator it4 = dstDrbToAddModList.begin ();
...
RrcConnectionRequestTestCase::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ (source.GetAmfid (),destination.GetAmfid (), "Different m_amfid!");
...
RrcConnectionReconfigurationTestCase::DoRun (void)
{
  ...
  reportConfigToAddMod.reportConfigEutra.threshold1.choice = NrRrcSap::ThresholdEutra::THRESHOLD_RSRP;
  reportConfigToAddMod.reportConfigEutra.threshold1.range = 15;
  reportConfigToAddMod.reportConfigEutra.threshold2.choice = NrRrcSap::ThresholdEutra::THRESHOLD_RSRQ;
  ...
  reportConfigToAddMod.reportConfigEutra.purpose = NrRrcSap::ReportConfigEutra::REPORT_STRONGEST_CELLS;
  reportConfigToAddMod.reportConfigEutra.triggerQuantity = NrRrcSap::ReportConfigEutra::RSRQ;
  reportConfigToAddMod.reportConfigEutra.reportQuantity = NrRrcSap::ReportConfigEutra::SAME_AS_TRIGGER_QUANTITY;
  ...
  NrRrcSap::MeasIdToAddMod measIdToAddMod,measIdToAddMod2;
...
MeasurementReportTestCase::DoRun (void)
{
  ...
  if (srcMeas.haveMeasResultNeighCells)
    {
      std::list<NrRrcSap::MeasResultEutra>::iterator itsrc = srcMeas.measResultListEutra.begin ();
      std::list<NrRrcSap::MeasResultEutra>::iterator itdst = dstMeas.measResultListEutra.begin ();
