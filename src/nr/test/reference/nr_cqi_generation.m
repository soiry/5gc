...
%% See the Testing section in the NR module documentation for more info
%% on how this is done. You might as well look into nr_amc.m
...
printf("AddTestCase (new NrCqiGenerationTestCase (\"UsePdcchForCqiGeneration\", \"true\", %d, %d , ));\n", commonRbDlMsc, commonRbUlMsc)
printf("AddTestCase (new NrCqiGenerationTestCase (\"UsePdcchForCqiGeneration\", \"false\", %d, %d , ));\n", privateRbDlMsc, commonRbUlMsc)
