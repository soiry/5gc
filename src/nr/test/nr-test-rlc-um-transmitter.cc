...
NrRlcUmTransmitterTestSuite::NrRlcUmTransmitterTestSuite ()
  : TestSuite ("nr-rlc-um-transmitter", SYSTEM)
{
  ...
  AddTestCase (new NrRlcUmTransmitterOneSduTestCase ("One SDU, one PDU"), TestCase::QUICK);
  AddTestCase (new NrRlcUmTransmitterSegmentationTestCase ("Segmentation"), TestCase::QUICK);
  AddTestCase (new NrRlcUmTransmitterConcatenationTestCase ("Concatenation"), TestCase::QUICK);
  AddTestCase (new NrRlcUmTransmitterReportBufferStatusTestCase ("ReportBufferStatus primitive"), TestCase::QUICK);
...
void
NrRlcUmTransmitterTestCase::DoRun (void)
{
  // LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
  // LogComponentEnable ("NrRlcUmTransmitterTest", logLevel);
...
void
NrRlcUmTransmitterTestCase::CheckDataReceived (Time time, std::string shouldReceived, std::string assertMsg)
{
  Simulator::Schedule (time, &NrRlcUmTransmitterTestCase::DoCheckDataReceived, this, shouldReceived, assertMsg);
}
...
void
NrRlcUmTransmitterOneSduTestCase::DoRun (void)
{
  // Create topology
...
void
NrRlcUmTransmitterSegmentationTestCase::DoRun (void)
{
  // Create topology
  NrRlcUmTransmitterTestCase::DoRun ();
...
void
NrRlcUmTransmitterConcatenationTestCase::DoRun (void)
{
  // Create topology
  NrRlcUmTransmitterTestCase::DoRun ();
 ...
 */
NrRlcUmTransmitterReportBufferStatusTestCase::NrRlcUmTransmitterReportBufferStatusTestCase (std::string name)
  : NrRlcUmTransmitterTestCase (name)
{
}
...
void
NrRlcUmTransmitterReportBufferStatusTestCase::DoRun (void)
{
  // Create topology
  NrRlcUmTransmitterTestCase::DoRun ();
