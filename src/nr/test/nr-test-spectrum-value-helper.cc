...
NS_LOG_COMPONENT_DEFINE ("NrTestSpectrumValueHelper");

class NrSpectrumModelTestCase : public TestCase
{
public:
  NrSpectrumModelTestCase (const char* str, uint16_t earfcn, uint8_t bw, std::vector<double> fcs);
  virtual ~NrSpectrumModelTestCase ();
...
NrSpectrumModelTestCase::NrSpectrumModelTestCase (const char* str, uint16_t earfcn, uint8_t bw, std::vector<double> fcs)
  :   TestCase (std::string ("SpectrumModel ") + str)
{
  NS_LOG_FUNCTION (this << str << earfcn << bw);
  m_actual = NrSpectrumValueHelper::GetSpectrumModel (earfcn, bw);
  m_expected = Create<SpectrumModel> (fcs);
}

NrSpectrumModelTestCase::~NrSpectrumModelTestCase ()
{
}

void 
NrSpectrumModelTestCase::DoRun (void)
{
...
class NrNoisePsdTestCase : public TestCase
{
public:
  NrNoisePsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double noiseFigureDb, SpectrumValue& expected);
  virtual ~NrNoisePsdTestCase ();
...
NrNoisePsdTestCase::NrNoisePsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double noiseFigureDb, SpectrumValue& expected)
  :   TestCase (str),
    m_actual (NrSpectrumValueHelper::CreateNoisePowerSpectralDensity (earfcn, bw, noiseFigureDb)),
    m_expected (Create<SpectrumValue> (expected))
{
  NS_LOG_FUNCTION (this << str << earfcn << bw << noiseFigureDb);
}

NrNoisePsdTestCase::~NrNoisePsdTestCase ()
{
}

void 
NrNoisePsdTestCase::DoRun (void)
{
...
class NrTxPsdTestCase : public TestCase
{
public:
  NrTxPsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double txPowerDbm, std::vector<int> activeRbs, SpectrumValue& expected);
  virtual ~NrTxPsdTestCase ();
...
NrTxPsdTestCase::NrTxPsdTestCase (const char* str, uint16_t earfcn, uint8_t bw, double txPowerDbm, std::vector<int> activeRbs, SpectrumValue& expected)
  :   TestCase (str),
    m_actual (NrSpectrumValueHelper::CreateTxPowerSpectralDensity (earfcn, bw, txPowerDbm, activeRbs)),
    m_expected (Create<SpectrumValue> (expected))
{
  NS_LOG_FUNCTION (this << str << earfcn << bw << txPowerDbm);
}

NrTxPsdTestCase::~NrTxPsdTestCase ()
{
}

void 
NrTxPsdTestCase::DoRun (void)
{
  NS_TEST_ASSERT_MSG_EQ (m_actual->GetSpectrumModelUid (), m_expected->GetSpectrumModelUid (), "SpectrumModel UID mismatch");
...
class NrSpectrumValueHelperTestSuite : public TestSuite
{
public:
  NrSpectrumValueHelperTestSuite ();
};

static NrSpectrumValueHelperTestSuite g_nrSpectrumValueHelperTestSuite;

NrSpectrumValueHelperTestSuite::NrSpectrumValueHelperTestSuite ()
  : TestSuite ("nr-spectrum-value-helper", UNIT)
{
//   LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
//   LogComponentEnable ("NrSpectrumModelTestCase", logLevel);
//   LogComponentEnable ("NrSpectrumValueHelperTestSuite", logLevel);
//   LogComponentEnable ("NrSpectrumValueHelper", logLevel);

 
  NS_LOG_INFO ("Creating NrSpectrumValueHelperTestSuite");
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc2160nrb6", 500, 6, fc2160nrb6), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc2160nrb15", 500, 15, fc2160nrb15), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc2160nrb25", 500, 25, fc2160nrb25), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc2160nrb50", 500, 50, fc2160nrb50), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc2160nrb75", 500, 75, fc2160nrb75), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc2160nrb100", 500, 100, fc2160nrb100), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc1730nrb6", 19400, 6, fc1730nrb6), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc1730nrb15", 19400, 15, fc1730nrb15), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc1730nrb25", 19400, 25, fc1730nrb25), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc1730nrb50", 19400, 50, fc1730nrb50), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc1730nrb75", 19400, 75, fc1730nrb75), TestCase::QUICK);
  ...
  AddTestCase (new NrSpectrumModelTestCase ("fc1730nrb100", 19400, 100, fc1730nrb100), TestCase::QUICK);


  SpectrumValue nfdB0earfcn500nrb6 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new NrNoisePsdTestCase ("nfdB0earfcn500nrb6", 500, 6, 0.000000, nfdB0earfcn500nrb6), TestCase::QUICK);

  SpectrumValue nfdB5earfcn500nrb6 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new NrNoisePsdTestCase ("nfdB5earfcn500nrb6", 500, 6, 5.000000, nfdB5earfcn500nrb6), TestCase::QUICK);

  SpectrumValue nfdB10earfcn500nrb6 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new NrNoisePsdTestCase ("nfdB10earfcn500nrb6", 500, 6, 10.000000, nfdB10earfcn500nrb6), TestCase::QUICK);

  SpectrumValue nfdB0earfcn500nrb15 (NrSpectrumValueHelper::GetSpectrumModel (500, 15));
  ...
  AddTestCase (new NrNoisePsdTestCase ("nfdB0earfcn500nrb15", 500, 15, 0.000000, nfdB0earfcn500nrb15), TestCase::QUICK);

  SpectrumValue nfdB5earfcn500nrb15 (NrSpectrumValueHelper::GetSpectrumModel (500, 15));
  ...
  AddTestCase (new NrNoisePsdTestCase ("nfdB5earfcn500nrb15", 500, 15, 5.000000, nfdB5earfcn500nrb15), TestCase::QUICK);

  SpectrumValue nfdB10earfcn500nrb15 (NrSpectrumValueHelper::GetSpectrumModel (500, 15));
  ...
  SpectrumValue spectrumValue_txpowdB10nrb6run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB10nrb6run1earfcn500", 500, 6, 10.000000, activeRbs_txpowdB10nrb6run1earfcn500, spectrumValue_txpowdB10nrb6run1earfcn500), TestCase::QUICK);
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB30nrb6run1earfcn500", 500, 6, 30.000000, activeRbs_txpowdB30nrb6run1earfcn500, spectrumValue_txpowdB30nrb6run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb25run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB10nrb25run1earfcn500", 500, 25, 10.000000, activeRbs_txpowdB10nrb25run1earfcn500, spectrumValue_txpowdB10nrb25run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb25run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB30nrb25run1earfcn500", 500, 25, 30.000000, activeRbs_txpowdB30nrb25run1earfcn500, spectrumValue_txpowdB30nrb25run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb100run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB10nrb100run1earfcn500", 500, 100, 10.000000, activeRbs_txpowdB10nrb100run1earfcn500, spectrumValue_txpowdB10nrb100run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb100run1earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB30nrb100run1earfcn500", 500, 100, 30.000000, activeRbs_txpowdB30nrb100run1earfcn500, spectrumValue_txpowdB30nrb100run1earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb6run2earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB10nrb6run2earfcn500", 500, 6, 10.000000, activeRbs_txpowdB10nrb6run2earfcn500, spectrumValue_txpowdB10nrb6run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb6run2earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 6));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB30nrb6run2earfcn500", 500, 6, 30.000000, activeRbs_txpowdB30nrb6run2earfcn500, spectrumValue_txpowdB30nrb6run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb25run2earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB10nrb25run2earfcn500", 500, 25, 10.000000, activeRbs_txpowdB10nrb25run2earfcn500, spectrumValue_txpowdB10nrb25run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb25run2earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 25));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB30nrb25run2earfcn500", 500, 25, 30.000000, activeRbs_txpowdB30nrb25run2earfcn500, spectrumValue_txpowdB30nrb25run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB10nrb100run2earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB10nrb100run2earfcn500", 500, 100, 10.000000, activeRbs_txpowdB10nrb100run2earfcn500, spectrumValue_txpowdB10nrb100run2earfcn500), TestCase::QUICK);
  ...
  SpectrumValue spectrumValue_txpowdB30nrb100run2earfcn500 (NrSpectrumValueHelper::GetSpectrumModel (500, 100));
  ...
  AddTestCase (new NrTxPsdTestCase ("txpowdB30nrb100run2earfcn500", 500, 100, 30.000000, activeRbs_txpowdB30nrb100run2earfcn500, spectrumValue_txpowdB30nrb100run2earfcn500), TestCase::QUICK);
