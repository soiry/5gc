...
#include "nr-test-nr-fdtbfq-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("LenaTestNrFdTbfqFfMacScheduler");

LenaTestNrFdTbfqFfMacSchedulerSuite::LenaTestNrFdTbfqFfMacSchedulerSuite ()
  : TestSuite ("nr-fdtbfq-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating LenaTestNrFdTbfqFfMacSchedulerSuite");
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (1,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (3,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (6,0,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (12,0,183000,185000,200,1,errorModel));// simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (1,4800,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (3,4800,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (6,4800,230500,125000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (12,4800,75250,62000,200,1,errorModel)); // simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (1,6000,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (3,6000,232000,201000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (6,6000,198500,97000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (12,6000,99250,48667,200,1, errorModel)); // simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (1,10000,232000,232000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (3,10000,232000,137000,200,1,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (6,10000,129166,67000,200,1,errorModel), TestCase::EXTENSIVE);
  //AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase1 (12,10000,64583,32667,200,1,errorModel));// simulation time = 1.5, otherwise, ul test will fail
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase2 (dist1,estThrFdTbfqDl1,packetSize1,1,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase2 (dist2,estThrFdTbfqDl2,packetSize2,1,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdTbfqFfMacSchedulerTestCase2 (dist3,estThrFdTbfqDl3,packetSize3,1,errorModel), TestCase::QUICK);

}

static LenaTestNrFdTbfqFfMacSchedulerSuite lenaTestNrFdTbfqFfMacSchedulerSuite;

// --------------- T E S T - C A S E   # 1 ------------------------------


std::string 
LenaNrFdTbfqFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, uint16_t dist)
{
...
LenaNrFdTbfqFfMacSchedulerTestCase1::LenaNrFdTbfqFfMacSchedulerTestCase1 (uint16_t nUser, uint16_t dist, double thrRefDl, double thrRefUl, uint16_t packetSize, uint16_t interval,bool errorModelEnabled)
...
LenaNrFdTbfqFfMacSchedulerTestCase1::~LenaNrFdTbfqFfMacSchedulerTestCase1 ()
{
}

void
LenaNrFdTbfqFfMacSchedulerTestCase1::DoRun (void)
{
  ...
  //LogComponentEnable ("NrFdTbfqFfMacScheduler", LOG_DEBUG);
  ...
  //Config::SetDefault ("ns3::NrEnbRrc::EpsBearerToRlcMapping", EnumValue (NrHelper::RLC_UM_ALWAYS));
...
//   LogComponentDisableAll (LOG_LEVEL_ALL);
  ...
  nrHelper->SetSchedulerType ("ns3::NrFdTbfqFfMacScheduler");
  ...
  for (uint32_t u = 0; u < ueNodes.GetN (); ++u)
    {
      ...
      nrHelper->ActivateDedicatedEpsBearer (ueDevice, bearer, NgcTft::Default ());  
    }
...
std::string 
LenaNrFdTbfqFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<uint16_t> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
LenaNrFdTbfqFfMacSchedulerTestCase2::LenaNrFdTbfqFfMacSchedulerTestCase2 (std::vector<uint16_t> dist, std::vector<uint32_t> estThrFdTbfqDl, std::vector<uint16_t> packetSize, uint16_t interval,bool errorModelEnabled)
...
LenaNrFdTbfqFfMacSchedulerTestCase2::~LenaNrFdTbfqFfMacSchedulerTestCase2 ()
{
}

void
LenaNrFdTbfqFfMacSchedulerTestCase2::DoRun (void)
{
