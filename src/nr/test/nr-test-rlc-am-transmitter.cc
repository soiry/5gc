...
NrRlcAmTransmitterTestSuite::NrRlcAmTransmitterTestSuite ()
  : TestSuite ("nr-rlc-am-transmitter", SYSTEM)
{
  // LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
  // LogComponentEnable ("NrRlcAmTransmitterTest", logLevel);

  AddTestCase (new NrRlcAmTransmitterOneSduTestCase ("One SDU, one PDU"), TestCase::QUICK);
  AddTestCase (new NrRlcAmTransmitterSegmentationTestCase ("Segmentation"), TestCase::QUICK);
  AddTestCase (new NrRlcAmTransmitterConcatenationTestCase ("Concatenation"), TestCase::QUICK);
  AddTestCase (new NrRlcAmTransmitterReportBufferStatusTestCase ("ReportBufferStatus primitive"), TestCase::QUICK);
...
void
NrRlcAmTransmitterTestCase::DoRun (void)
{
  // LogLevel logLevel = (LogLevel)(LOG_PREFIX_FUNC | LOG_PREFIX_TIME | LOG_LEVEL_ALL);
  // LogComponentEnable ("NrRlcAmTransmitterTest", logLevel);
...
void
NrRlcAmTransmitterTestCase::CheckDataReceived (Time time, std::string shouldReceived, std::string assertMsg)
{
  Simulator::Schedule (time, &NrRlcAmTransmitterTestCase::DoCheckDataReceived, this, shouldReceived, assertMsg);
}
...
void
NrRlcAmTransmitterOneSduTestCase::DoRun (void)
{
  // Create topology
...
void
NrRlcAmTransmitterSegmentationTestCase::DoRun (void)
{
  // Create topology
  NrRlcAmTransmitterTestCase::DoRun ();
...
void
NrRlcAmTransmitterConcatenationTestCase::DoRun (void)
{
  // Create topology
  NrRlcAmTransmitterTestCase::DoRun ();
 ...
 */
NrRlcAmTransmitterReportBufferStatusTestCase::NrRlcAmTransmitterReportBufferStatusTestCase (std::string name)
  : NrRlcAmTransmitterTestCase (name)
{
}
...
void
NrRlcAmTransmitterReportBufferStatusTestCase::DoRun (void)
{
  // Create topology
  NrRlcAmTransmitterTestCase::DoRun ();
