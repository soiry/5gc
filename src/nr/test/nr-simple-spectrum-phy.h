...
#ifndef NR_SIMPLE_SPECTRUM_PHY_H
#define NR_SIMPLE_SPECTRUM_PHY_H
 ...
 * \ingroup nr
 *
 * The NrSimpleSpectrumPhy models the physical layer of NR
...
class NrSimpleSpectrumPhy : public SpectrumPhy
{

public:
  NrSimpleSpectrumPhy ();
  virtual ~NrSimpleSpectrumPhy ();
...
#endif /* NR_SIMPLE_SPECTRUM_PHY_H */
