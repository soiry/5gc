...
#include "nr-test-nr-fdbet-ff-mac-scheduler.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("LenaTestNrFdBetFfMacScheduler");

LenaTestNrFdBetFfMacSchedulerSuite::LenaTestNrFdBetFfMacSchedulerSuite ()
  : TestSuite ("nr-fdbet-ff-mac-scheduler", SYSTEM)
{
  NS_LOG_INFO ("creating LenaTestNrFdBetFfMacSchedulerSuite");
  ...
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (1,0,2196000,2292000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (3,0,749000,749000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (6,0,373000,373000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (12,0,185000,184670, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (1,4800,1383000,807000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (3,4800,469000,253000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (6,4800,233500,125000, errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (12,4800,113000,62000, errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (1,6000,1191000,621000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (3,6000,389000,201000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (6,6000,193000,97000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (12,6000,97000,48667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (1,10000,775000,421000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (3,10000,253000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (6,10000,125000,67000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (12,10000,61000,32667,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (1,20000,421000,137000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (3,20000,137000,41000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (6,20000,67000,22000,errorModel), TestCase::EXTENSIVE);
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase1 (12,20000,32000,12000,errorModel), TestCase::EXTENSIVE);
  ...
  AddTestCase (new LenaNrFdBetFfMacSchedulerTestCase2 (dist, estAchievableRateDl, estThrFdBetUl, errorModel), TestCase::QUICK);
}

static LenaTestNrFdBetFfMacSchedulerSuite lenaTestNrFdBetFfMacSchedulerSuite;
...
std::string 
LenaNrFdBetFfMacSchedulerTestCase1::BuildNameString (uint16_t nUser, uint16_t dist)
{
...
LenaNrFdBetFfMacSchedulerTestCase1::LenaNrFdBetFfMacSchedulerTestCase1 (uint16_t nUser, uint16_t dist, double thrRefDl, double thrRefUl, bool errorModelEnabled)
...
LenaNrFdBetFfMacSchedulerTestCase1::~LenaNrFdBetFfMacSchedulerTestCase1 ()
{
}

void
LenaNrFdBetFfMacSchedulerTestCase1::DoRun (void)
{
  ...
  nrHelper->SetSchedulerType ("ns3::NrFdBetFfMacScheduler");
...
std::string 
LenaNrFdBetFfMacSchedulerTestCase2::BuildNameString (uint16_t nUser, std::vector<uint16_t> dist)
{
  std::ostringstream oss;
  oss << "distances (m) = [ " ;
...
LenaNrFdBetFfMacSchedulerTestCase2::LenaNrFdBetFfMacSchedulerTestCase2 (std::vector<uint16_t> dist, std::vector<uint32_t> estAchievableRateDl, std::vector<uint32_t> estThrFdBetUl, bool errorModelEnabled)
...
LenaNrFdBetFfMacSchedulerTestCase2::~LenaNrFdBetFfMacSchedulerTestCase2 ()
{
}

void
LenaNrFdBetFfMacSchedulerTestCase2::DoRun (void)
{
