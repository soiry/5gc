...
void
PhyTxStatsCalculator::DlPhyTransmission (NrPhyTransmissionStatParameters params)
{
...
void
PhyTxStatsCalculator::UlPhyTransmission (NrPhyTransmissionStatParameters params)
{
  NS_LOG_FUNCTION (this << params.m_cellId << params.m_imsi << params.m_timestamp << params.m_rnti << params.m_layer << params.m_mcs << params.m_size << params.m_rv << params.m_ndi);
