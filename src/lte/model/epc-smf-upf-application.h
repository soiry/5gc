...
#ifndef EPC_SMF_UPF_APPLICATION_H
#define EPC_SMF_UPF_APPLICATION_H
 ...
 */
class EpcSmfUpfApplication : public Application
{
  friend class MemberEpcS11SapSmf<EpcSmfUpfApplication>;
...
public:
   ...
   */
  EpcSmfUpfApplication (const Ptr<VirtualNetDevice> tunDevice, const Ptr<Socket> s1uSocket);

  /** 
   * Destructor
   */
  virtual ~EpcSmfUpfApplication (void);
...
#endif /* EPC_SMF_UPF_APPLICATION_H */
