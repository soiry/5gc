 ...
 */
class EpcS11SapSmf : public EpcS11Sap
{
public:
...
/**
 * Template for the implementation of the EpcS11SapSmf as a member
 * of an owner class of type C to which all methods are forwarded
 * 
 */
template <class C>
class MemberEpcS11SapSmf : public EpcS11SapSmf
{
public:
  MemberEpcS11SapSmf (C* owner);

  // inherited from EpcS11SapSmf
...
template <class C>
MemberEpcS11SapSmf<C>::MemberEpcS11SapSmf (C* owner)
  : m_owner (owner)
{
}

template <class C>
MemberEpcS11SapSmf<C>::MemberEpcS11SapSmf ()
{
}

template <class C>
void MemberEpcS11SapSmf<C>::CreateSessionRequest (CreateSessionRequestMessage msg)
{
  m_owner->DoCreateSessionRequest (msg);
}

template <class C>
void MemberEpcS11SapSmf<C>::ModifyBearerRequest (ModifyBearerRequestMessage msg)
{
  m_owner->DoModifyBearerRequest (msg);
}

template <class C>
void MemberEpcS11SapSmf<C>::DeleteBearerCommand (DeleteBearerCommandMessage msg)
{
  m_owner->DoDeleteBearerCommand (msg);
}

template <class C>
void MemberEpcS11SapSmf<C>::DeleteBearerResponse (DeleteBearerResponseMessage msg)
{
